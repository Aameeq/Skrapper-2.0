// Skraper Web App - Main JavaScript with Backend API Integration
class SkraperApp {
    constructor() {
    ...
    async checkBackendStatus() {
        try {
            ...
            if (data.skraper_available) {
                console.log('✅ Backend and Skraper are available');
                this.showBackendStatus(true);
            } else {
                console.log('⚠️  Backend available but Skraper CLI not found');
                this.showBackendStatus(false, 'Skraper CLI not installed');
            }
        } catch (error) {
